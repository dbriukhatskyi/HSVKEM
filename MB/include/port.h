...
#elif defined (__AVR_ATmega640__) || defined (__AVR_ATmega2560__)

#define USE_PORT_1

#if defined (USE_PORT_1)
#define UCSRB           UCSR1B
#define UBRR            UBRR1L
#define UDR             UDR1
#define UDRE            UDRE1
...
#define USART_TX_vect   USART2_TX_vect
#elif defined (USE_PORT_3)
#define UCSRB           UCSR3B
#define UBRR            UBRR3L
#define UDR             UDR3
#define UDRE            UDRE3
...
#define USART_TX_vect   USART3_TX_vect
#define RTS_PIN         PJ2
#define RTS_DDR         DDRJ
#define RTS_PORT        PORTJ
#else
#define UCSRB           UCSR0B
#define UBRR            UBRR0L
#define UDR             UDR0
